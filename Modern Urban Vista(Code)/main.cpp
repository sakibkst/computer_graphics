...
Group No:02
Group Member: Md. Omar Faruk Sakib
ID:21-45077-2
Section:F
...
void makerail()
{
    ...
    glColor3f(1, 1, 1);
    rectangle(-70,0,180,60);
    glColor3f(0.4, 0.4, 0.4);
    rectangle1(-100,0,-70,0,-100,20,-70,60);
    glColor3f(0.75, 0.75, 0.75);
    rectangle1(-70,60,180,60,-75,70,170,70);
...
int main(int argc, char *argv[])
{
    ...
    glutCreateWindow("Modern Urban Vista");
    init();
